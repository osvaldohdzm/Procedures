...
\reporttitle{Web application vulnerability analysis} % The report title to appear on the title page and page headers, do not create manual new lines here as this will carry over to page headers

\reportsubtitle{Procedure} % Report subtitle, include new lines if needed

\reportauthors{Documented by:\\\smallskip Osvaldo H.M.} % Report authors/group/department, include new lines if needed

\reportdate{\today} % Report date, include new lines for additional information if needed

\rightheadercontent{\includegraphics[width=3cm]{creodocs_logo.png}} % The content in the right header, you may want to add your own company logo or use your company/department name or leave this command empty for no right header content
...
\begin{fullwidth} % Use the whole page width
	...
	\hfill\includegraphics[width=5cm]{creodocs_logo.png} % Company logo
